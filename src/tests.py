...
class TestSuite:
    ...
    def testMetrics(self):  
        ...
        return bfsMetrics, dfsMetrics, iddfsMetrics, greedyMetrics, astarMetrics, wAstarMetrics, IdAstarMetrics
...
def main():
    ...
    bfsMetrics, dfsMetrics, iddfsMetrics, greedyMetrics, astarMetrics, wastarMetrics, idastarMetrics = test.testMetrics()
